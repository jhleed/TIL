...
![](Untitled-b8240c1f-8a92-48e9-b35b-4de6dded94fe.png)

![](F5D5059B-64DB-417E-9D6D-35D6A347083E-06a53134-2684-4dfc-80ab-db16a9ed947d.jpeg)

- **주니어 개발자를 위한 격언**이라는 거창한 주제인데, 발표 시간은 15분이다. 짧은 시간에 어떤 내용을 담아야 강렬한 메세지를 줄 수 있을까..
- 일단 1차로 작성해서 피드백 요청드렸다. 세 시간 정도 걸렸는데 생각보다 재밌게 만들었다. 근데 기술적 내용도 없고, 너무 짧은 시간에 많은 내용을 표현하려다보니 내용이 추상적인 감이 있다. 과연 도움이 될까 싶은 기분이 든다.. 좀 고민해보고 필요하면 다시 고쳐야겠다.
